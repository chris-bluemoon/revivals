...
List<Dress> myDresses = [
  ...
  Dress(id: '-', name: 'Polkadot', brand: 'ZIMMERMANN', colour: 'Blue', size: 8, rentPrice: 2900, rrp: 62000, description: 'Description'),
  ...
  Dress(id: '-', name: "Applique", brand: 'ZIMMERMANN', colour: 'Floral Print', size: 8, rentPrice: 3000, rrp: 35000, description: 'Description'),
  ...
  Dress(id: '-', name: "Farah", brand: 'BRONX AND BANCO', colour: 'Pink', size: 8, rentPrice: 3700, rrp: 32000, description: 'Description'),
  Dress(id: '-', name: "Genevieve", brand: 'HOUSE OF CB', colour: 'Pink', size: 6, rentPrice: 2000, rrp: 10000, description: 'Description'),
  Dress(id: '-', name: "Tuxedo", brand: 'ZIMMERMANN', colour: 'Pink', size: 8, rentPrice: 3000, rrp: 35000, description: 'Description'),
