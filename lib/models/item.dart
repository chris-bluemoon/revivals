...
List<Item> allItems = [
  ...
  Item(id: '-', type: 'dress', bookingType: 'rental', dateAdded: '01-01-2023', occasion: ['party','date night'], style: 'classic', name: 'Delfina', brand: 'ALC', colour: ['Blue','Black'], size: ['8','8'], length: 'midi', print: 'none', sleeve: 'short sleeve', rentPrice: 2300, buyPrice: 0, rrp: 25300, description: 'Short Description', bust: '', waist: '', hips: '', longDescription: '', imageId: '', ),
