...
class CategoryListView extends StatelessWidget {
    ...
    return ListView(
      ...
      children: <Widget>[
       GestureDetector(
         ...
         onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => (CategoryItems('dress'))));
         },
       ),
       GestureDetector(
  child: Container(
  ...
  onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => (CategoryItems('bag'))));
         ...
         child: Container(
          ...
          child: Image.asset('assets/img/new_items/jacket_transparent2.webp', height: 100),
               ...
               SizedBox(width: 100),
               Text('JACKETS', style: TextStyle(fontSize: 16)),
             ],
           )
         ),
         onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => (CategoryItems('jacket'))));
         },
       ),
              GestureDetector(
  child: Container(
  ...
  onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => (CategoryItems('pantsuit'))));
