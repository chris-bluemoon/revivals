...
class OccasionItemCard extends StatefulWidget {
  OccasionItemCard(this.item, {super.key});

  final Item item;

  @override
  State<OccasionItemCard> createState() => _OccasionItemCardState();
}

class _OccasionItemCardState extends State<OccasionItemCard> {
