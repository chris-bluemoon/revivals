...
class StyleItemCard extends StatefulWidget {
  StyleItemCard(this.item, {super.key});

  final Item item;

  @override
  State<StyleItemCard> createState() => _StyleItemCardState();
}

class _StyleItemCardState extends State<StyleItemCard> {
