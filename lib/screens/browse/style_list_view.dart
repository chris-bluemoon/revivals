    ...
    child: Row(
      children: [
        ...
        Padding(
          ...
          child: Image.asset('assets/img/item2/classic_transparent.png', height: screenWidth*0.2),
        ),
      ],
    )
  ),
         ...
         child: Container(
           ...
           child: Row(
             children: [
               Padding(
          padding: EdgeInsets.only(left: leftRightPadding),
          child: Image.asset('assets/img/item2/vintage_transparent.png', height: screenWidth*0.2),
               ),
               const Expanded(child: SizedBox()),
               Padding(
                 padding: EdgeInsets.only(right: leftRightPadding),
  ...
  child: Container(
    ...
    child: Row(
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(right: leftRightPadding),
          child: Image.asset('assets/img/item2/artsy_transparent.png', height: screenWidth*0.2),
        ),
      ],
    )
  ),
         ...
         child: Container(
           ...
           child: Row(
             children: [
               Padding(
          padding: EdgeInsets.only(left: leftRightPadding),
          child: Image.asset('assets/img/item2/resort_transparent.png', height: screenWidth*0.2),
               ),
               const Expanded(child: SizedBox()),
               Padding(
                 padding: EdgeInsets.only(right: leftRightPadding),
