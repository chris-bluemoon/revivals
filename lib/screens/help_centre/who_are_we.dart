                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(text: 'We invite you to explore our collection and experience the joy of dressing up without the commitment of a permanent wardrobe addition. Join the [Your Business Name] community and let us help you create memorable moments with style and grace.', style: GoogleFonts.openSans(textStyle: Theme.of(context).textTheme.bodyMedium, fontSize: width*0.03, color: Colors.black, fontWeight: FontWeight.normal,),),
                              // TextSpan(text: '(for pants or jumpsuits): Measure from the crotch seam to the bottom of the leg.',
                            ]))
                    ),
                  ]),
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(text: 'Thank you for choosing [Your Business Name]. We can’t wait to be part of your next special occasion!', style: GoogleFonts.openSans(textStyle: Theme.of(context).textTheme.bodyMedium, fontSize: width*0.03, color: Colors.black, fontWeight: FontWeight.normal,),),
                              // TextSpan(text: '(for pants or jumpsuits): Measure from the crotch seam to the bottom of the leg.',
                            ]))
                    ),
                  ]),
